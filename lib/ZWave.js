...
class ZWave {
  ...
  setPollInterval (intervalInMillisec) {
    this._ozw.setPollInterval(intervalInMillisec)
  }
  
  enablePoll (id, intensity) {
    const [
      nodeId,
      commandClass,
      valueInstance,
    ...
    this._ozw.enablePoll(nodeId, commandClass, valueInstance, valueIndex, intensity)
  }
...
ZWave.SWITCH_MULTILEVEL_INDEX_LEVEL = 0
